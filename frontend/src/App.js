                                                    ...
                                                    border: "1px solid #c8d6ff",
                                                            ...
                                                            padding: 10,
                                                                            ...
                                                                            alignItems: "stretch",
                                                                                    ...
                                                                                    color: "#888",
                                                                                    background: "#fafafa",
                                                                                }, children: "\u30C6\u30F3\u30D7\u30EC\u672A\u53D6\u5F97" }))] })] })] }))] })] }))] }), _jsxs("div", { className: "sectionCard muted", children: [_jsxs("button", { type: "button", onClick: () => setAutoPanelOpen((prev) => !prev), style: {
                                            width: "100%",
                                            textAlign: "left",
                                            fontSize: 13,
                                            fontWeight: 700,
                                            ...
                                            padding: 0,
                                                    ...
                                                    border: "1px solid #c8d6ff",
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                detail: "Template Mode: 透過PNGテンプレートを alpha mask / edge / 回転(0/90/180) / 勾配方向ヒストグラムで事前キャッシュし、ROI側も二値→エッジで前処理。第1段はエッジ画像の matchTemplate（可能時mask付き）で候補抽出、第2段はTopKのみ距離変換Chamferで再ランキングします。最終スコアが近接する場合（差が小さい場合）はROI窓とテンプレの角度ヒストグラム類似度でタイブレークし、斜め成分の差を識別します。",
                                                                accent: "#546e7a",
                                                                bg: "#eceff1",
                                                            },
                                                        ].map((item) => {
