...
@app.get("/templates/{project}/{class_name}/{template_name}/overlay-red")
def get_template_overlay_red_image(project: str, class_name: str, template_name: str) -> Response:
    project_templates = templates_cache.get(project)
    if project_templates is None:
        raise HTTPException(status_code=404, detail="project not found")
    class_templates = project_templates.get(class_name)
